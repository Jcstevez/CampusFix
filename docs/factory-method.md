...
La implementación utiliza la abstracción `Incidencia` como tipo de retorno del Factory Method, evitando que el consumidor del creador tenga que depender directamente de una implementación concreta.

La evidencia de este principio se fortalecerá cuando exista un componente cliente que consuma `Incidencia` mediante la abstracción.
...
Actualmente existen dos clases de prueba:
